...
This is a repo for [my workshop]([https://www.eventbrite.co.uk/e/workshop-write-your-own-scratch-extension-tickets-533502218497](https://github.com/SkillSpawnPlayz/scratchseek-V1)) at the [Raspberry Pi Clubs Conference](https://www.raspberrypi.org/clubs-conference-2023/) - about how to create your own custom blocks for Scratch.
...
Go to [INSTRUCTIONS.md](./INSTRUCTIONS.md) to make your own step-by-step guide, go through the process in [this video](https://youtu.be/bX9ZqhuxtnI).
...
If you make something with this, please [click here to go to the offical user.](https://github.com/dalelane/scratch-extension-development/issues) - I'd love to hear about it.
